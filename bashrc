...
# Standard navigation & listing shorthand
alias ll='ls -alF'
alias la='ls -A'
alias l='ls -CF'

# --- Added Productivity & Safety Aliases ---
alias c='clear'
alias ..='cd ..'
alias ...='cd ../..'
alias ....='cd ../../..'
alias mkdir='mkdir -p'             # Automatically creates parent directories if needed
alias df='df -h'                   # Human-readable disk usage
alias free='free -m'               # Show RAM usage in MB
alias cp='cp -iv'                  # Interactive copy (asks before overwriting) + verbose
